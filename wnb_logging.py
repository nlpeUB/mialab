...
def log_metric_in_wnb(model, feature_names, result_summary_file, pre_process_params, subfolder_path):
    ...
    dice_dict["MEAN_DICE"] = results_df[(results_df["STATISTIC"] == "MEAN") & (results_df["METRIC"] == "DICE")]["VALUE"].mean()
    dice_dict["MEAN_HDRFDST"] = results_df[(results_df["STATISTIC"] == "MEAN") & (results_df["METRIC"] == "HDRFDST")]["VALUE"].mean()
